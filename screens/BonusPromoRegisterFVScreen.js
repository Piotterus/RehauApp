...
export default class BonusPromoRegisterFVScreen extends Component {
    ...
    sendImage(data) {
        ...
        let url = `https://api.verbum.com.pl/${this.props.appId}/${this.props.token}/invoice/add`;
        ...
        fetch(url, {
            ...
            .then(response => response.json())
            .then(responseJson => {
                if (responseJson.invoiceAdd.error.code === 0) {
                    this.setState({
                        isLoading: false,
                    ...
                    this.setState({
                        isLoading: false,
                        error: responseJson.invoiceAdd.error
                    }, () => this.setModalErrorVisible(true))
                }
            })
            .catch((error) => {
